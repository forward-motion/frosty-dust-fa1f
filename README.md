...
```
npm create cloudflare@latest -- --template=cloudflare/templates/frosty-dust-fa1f
```

## Preview Deployment

A live public deployment of this template is available at [https://frosty-dust-fa1f.templates.workers.dev](https://frosty-dust-fa1f.templates.workers.dev)
